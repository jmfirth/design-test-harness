...
```bash
git clone https://github.com/geekhive/design-test-harness.git
cd design-test-harness
...
```javascript
import * as dth from 'design-test-harness'
dth.render('body');
```
...
Thanks to [typescript-library-starter](https://github.com/alexjoverm/typescript-library-starter) for a great jumpstart.